...
int main()
{
	...
	//initialize textRect with the coordinates of the rectangle thath wraps messageText
	FloatRect textRect = messageText.getLocalBounds();

	//sets the center of messageText to the center of the screen
	...
	**************/
	...
	while (window.isOpen()) {
		...
		if (Keyboard::isKeyPressed(Keyboard::Return)) {
			...
			//make sure the gavestone is hidden
		...
		if (acceptInput) {
			if (Keyboard::isKeyPressed(Keyboard::Right)) {
				...
				//add the amount of time remaning
				timeRemaning += (2.0f / score) + .15;
		...
		*/
		...
		if (!paused) {
			...
			if (!beeActive) {
				...
				//Move the bee
				/*
				* dt.asSeconds() return how long the previous frame of animation took
				* 5000fps -> 0.0002
				*/
				srand((int)time(0));
			...
			if (!cloudActive1) {
				...
				srand((int)time(0) * 10);
				spriteCloud1.setPosition(spriteCloud1.getPosition().x + (cloud1Speed
					* dt.asSeconds()), spriteCloud1.getPosition().y);
			...
			if (!cloudActive2) {
				...
				srand((int)time(0) * 20);
				spriteCloud2.setPosition(spriteCloud2.getPosition().x + (cloud2Speed
					* dt.asSeconds()), spriteCloud2.getPosition().y);
			...
			if (!cloudActive3) {
				...
				srand((int)time(0) * 30);
				spriteCloud3.setPosition(spriteCloud3.getPosition().x + (cloud3Speed
					* dt.asSeconds()), spriteCloud3.getPosition().y);
